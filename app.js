...
function multiplyArray(multArr) { 
    ...
    x=multiply(x, testArray[2])[0];
    var message=('The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + x + '.');
    return[x, message]
...
function multiplyAnyArray(dynamicArray) {
    ...
    var message=('The numbers ' + testDynamicArray + ' have a product of ' + x + '.')
    return[x, message]
